...
const int NB = 20; // Filter length
const double B[20] = {
	0.00158878927351, 0.004897921828125, 0.004439644032297, -0.009905841754043,
	-0.03936388702647, -0.06086875124198, -0.0335153477433, 0.06544963632095,
	0.204924495402, 0.3078737154523, 0.3078737154523, 0.204924495402,
	0.06544963632095, -0.0335153477433, -0.06086875124198, -0.03936388702647,
	-0.009905841754043, 0.004439644032297, 0.004897921828125, 0.00158878927351
};
...
int checkHeader(wave_header header)
{
	...
	if (string(header.ChunkID, 4).compare("RIFF")) {
		...
		cerr << "Sample rate was \"" << header.SampleRate << "\" not 48000 or 16000" << endl;
		return 7;
	} else {
		return 0;
	}
